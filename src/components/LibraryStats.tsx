...
export default function LibraryStats({items,onClose}:{items:Anime[];onClose:()=>void}){
 ...
 return <div className="sheet statsSheet" onClick={onClose}><section ref={dialogRef} className="panel statsModal" role="dialog" aria-modal="true" aria-labelledby={titleId} tabIndex={-1} onClick={e=>e.stopPropagation()}>
